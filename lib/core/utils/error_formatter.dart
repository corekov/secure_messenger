  ...
  static String formatBackendError(dynamic errorData) {
    ...
    if (errorData is Map) {
      if (errorData.containsKey('error')) {
        ...
        if (errorString.contains('failed on the \'required\' tag') ||
            errorString.contains('Error:Field validation for')) {
          ...
          if (errorString.contains('\'Device_name\' failed') ||
              errorString.contains('\'DeviceName\' failed')) {
        ...
        if (errorString == 'record not found' ||
